...
import TaxBenefitRecommendations from './TaxBenefitRecommendations';
import LoanRecommendations from './LoanRecommendations';

const EnhancedReceiptFinancePlatform = () => {
    ...
    const COLORS = ['#3b82f6', '#6366f1', '#10b981', '#64748b'];
    ...
    const DashboardView = () => (
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700 rounded-xl p-6 text-white">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4">
                        <div className="w-20 h-20 bg-white/20 backdrop-blur rounded-full flex items-center justify-center relative">
                            ...
                            <div className="absolute -bottom-1 bg-emerald-400 text-indigo-900 px-2 py-0.5 rounded-full text-xs font-bold">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                {isPremium && <span className="bg-emerald-400 text-indigo-900 px-2 py-0.5 rounded-full text-xs font-bold">PRO</span>}
                            </div>
            ...
            {aiInsights.filter(i => i.priority === 'high').length > 0 && (
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-indigo-300 rounded-xl p-5">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2 mb-3">
                                <h3 className="font-bold text-lg text-indigo-900">🔥 세무사 AI 긴급 알림</h3>
                            ...
                            <div className="space-y-4">
                                {aiInsights.filter(i => i.priority === 'high').slice(0, 2).map(insight => (
                                    <div key={insight.id} className="bg-white/60 backdrop-blur rounded-lg p-4">
                                        <div className="flex items-start gap-3 mb-3">
                                            <insight.icon className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-0.5" />
                                            <div className="flex-1">
                                                <div className="font-bold text-indigo-900 mb-1">{insight.title}</div>
                                                <div className="text-sm text-indigo-800">{insight.description}</div>
                                            </div>
                                        </div>
                                        {insight.potentialSaving > 0 && (
                                            <div className="flex items-center justify-between mb-3">
                                                <span className="text-xs text-gray-600">절감 가능 금액</span>
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition font-semibold text-sm shadow-sm"
                                        >
                                            {insight.action} →
                                        </button>
                                    </div>
            ...
            {/* Tax Health Score with Improvement Suggestions */}
            <div className="bg-white rounded-xl p-6 shadow-sm border">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                        <Shield className="w-6 h-6 text-blue-500" />
                        <h3 className="font-bold text-xl">Tax Health Score™</h3>
                    </div>
                    <button
                        onClick={() => setShowPDFReportModal(true)}
                        className="text-sm bg-blue-50 text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-100 transition flex items-center gap-2 font-semibold"
                    >
                ...
                <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div className="relative w-40 h-40">
                            <svg className="w-full h-full transform -rotate-90">
                                ...
                                <circle
                                    ...
                                    cy="80"
                                    r="70"
                                    stroke={taxHealthScore >= 90 ? '#10b981' : taxHealthScore >= 70 ? '#3b82f6' : '#f59e0b'}
                                    strokeWidth="12"
                                    fill="none"
                                    strokeDasharray={`${(taxHealthScore / 100) * 440} 440`}
                                    strokeLinecap="round"
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <div className="text-xs text-gray-500 mt-1">
                                    {taxHealthScore >= 90 ? '최상' : taxHealthScore >= 70 ? '양호' : '보통'}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        <h4 className="font-semibold text-sm text-gray-700 mb-3">점수 구성</h4>
                        <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            <div className="flex items-center gap-2">
                                <CheckCircle className="w-5 h-5 text-green-500" />
                                <span className="text-sm font-medium">공제 활용도</span>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium">증빙 완성도</span>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium">납부 이력</span>
                            </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4">
                        ...
                        <div className="space-y-3 text-sm">
                            <div className="flex items-start gap-2">
                                <ArrowUp className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                                <div>
                                    <div className="font-semibold text-gray-800">교육비 공제 활용</div>
                                    <div className="text-xs text-gray-600 mt-0.5">
                                        온라인 강의 구매로 <span className="font-bold text-green-600">+5점</span> 향상 가능
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-start gap-2">
                                <ArrowUp className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                                <div>
                                    <div className="font-semibold text-gray-800">체크카드 전환</div>
                                    <div className="text-xs text-gray-600 mt-0.5">
                                        공제율 증가로 <span className="font-bold text-green-600">+8점</span> 향상 가능
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-start gap-2">
                                <ArrowUp className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                                <div>
                                    <div className="font-semibold text-gray-800">의료비 증빙 추가</div>
                                    <div className="text-xs text-gray-600 mt-0.5">
                                        누락 서류 보완으로 <span className="font-bold text-green-600">+3점</span> 향상 가능
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {/* Deduction Tracker & AI Recommendations */}
            <div className="bg-white rounded-xl p-6 shadow-sm border">
                <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center gap-2">
                        <Target className="w-6 h-6 text-purple-500" />
                        <h3 className="font-bold text-xl">공제 항목 실시간 추적</h3>
                    ...
                    <button
                        ...
                        className="text-sm text-purple-600 hover:text-purple-700 transition flex items-center gap-1 font-semibold"
                    >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {Object.entries(deductionTracker).map(([key, item]) => {
                        ...
                        return (
                            <div key={key} className={`border-2 rounded-xl p-4 transition-all hover:shadow-md ${isNearThreshold ? 'border-orange-400 bg-orange-50' : 'border-gray-200 hover:border-gray-300'}`}>
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        <div className={`w-12 h-12 bg-${item.color}-100 rounded-xl flex items-center justify-center shadow-sm`}>
                                ...
                                <div className="mb-3">
                                    <div className="flex justify-between text-sm mb-2">
                                        <span className="font-semibold text-gray-700">₩{item.current.toLocaleString()}</span>
                                        <span className="text-gray-500">/ ₩{item.maxDeduction.toLocaleString()}</span>
                                    </div>
                                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                                        <div
                                            className={`h-2.5 rounded-full bg-gradient-to-r from-${item.color}-400 to-${item.color}-600 transition-all`}
                                            style={{ width: `${Math.min(progress, 100)}%` }}
                                        />
                                    </div>
                                    <div className="text-xs text-gray-500 mt-1">{Math.round(progress)}% 활용</div>
                                </div>

                                {item.potentialSaving > 0 && (
                                    <div className="bg-green-50 border border-green-200 rounded-lg p-2 text-center">
                                        <div className="text-xs text-green-700 mb-0.5">추가 절감 가능</div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-xl">출석 체크</h3>
                    </div>
                    <button
                        onClick={handleAttendanceCheck}
                        disabled={attendanceChecked.every(d => d)}
                        className={`px-5 py-2.5 rounded-lg font-bold transition shadow-sm ${attendanceChecked.every(d => d)
                ...
                <div className="grid grid-cols-7 gap-3">
                    {['월', '화', '수', '목', '금', '토', '일'].map((day, idx) => (
                        <div key={idx} className="text-center">
                            ...
                            <div className={`w-full aspect-square rounded-xl flex items-center justify-center transition-all ${attendanceChecked[idx]
            ...
            {/* Daily Missions - 오늘의 미션 (간결하게) */}
            <div className="bg-white rounded-xl p-6 shadow-sm border">
                <div className="flex items-center gap-2 mb-4">
                    <Target className="w-6 h-6 text-emerald-500" />
                    <h3 className="font-bold text-xl">오늘의 미션</h3>
                </div>
                <div className="grid md:grid-cols-3 gap-3">
                    {dailyMissions.map(mission => (
                        <div key={mission.id} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200 hover:shadow-md transition">
                            <div className="flex items-center justify-between mb-3">
                                <span className="font-semibold text-sm text-gray-800">{mission.title}</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-5 text-white shadow-lg hover:shadow-xl transition">
                    <div className="flex items-center justify-between mb-3">
                        <Wallet className="w-6 h-6" />
                        <span className="text-xs bg-white/20 px-2 py-1 rounded-full font-semibold">이번 달</span>
                    </div>
                    <div className="text-2xl font-bold mb-1">₩{stats.totalSpent.toLocaleString()}</div>
                    <div className="text-xs opacity-90">총 지출</div>
                </div>

                <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-5 text-white shadow-lg hover:shadow-xl transition">
                    <div className="flex items-center justify-between mb-3">
                        <TrendingUp className="w-6 h-6" />
                        <span className="text-xs bg-white/20 px-2 py-1 rounded-full font-semibold">절감액</span>
                    </div>
                    <div className="text-2xl font-bold mb-1">₩{Math.floor(userProfile.totalSaved / 1000)}K</div>
                    <div className="text-xs opacity-90">누적 절감</div>
                </div>

                <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-5 text-white shadow-lg hover:shadow-xl transition">
                    <div className="flex items-center justify-between mb-3">
                        <Trophy className="w-6 h-6" />
                        <span className="text-xs bg-white/20 px-2 py-1 rounded-full font-semibold">배지</span>
                    </div>
                    <div className="text-2xl font-bold mb-1">{userProfile.badges.length}개</div>
                    <div className="text-xs opacity-90">획득 완료</div>
                </div>

                <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-5 text-white shadow-lg hover:shadow-xl transition">
                    <div className="flex items-center justify-between mb-3">
                        <Gift className="w-6 h-6" />
                        <span className="text-xs bg-white/20 px-2 py-1 rounded-full font-semibold">포인트</span>
                    </div>
                    <div className="text-2xl font-bold mb-1">{userProfile.points.toLocaleString()}P</div>
                    <div className="text-xs opacity-90">사용 가능</div>
                </div>
            </div>

            {/* Category Spending & Budget Management - 원형 차트 하나로 간결하게 */}
            <div className="grid md:grid-cols-2 gap-6">
                {/* Single Pie Chart for Category Spending */}
                <div className="bg-white rounded-xl p-6 shadow-sm border">
                        ...
                        {stats.budgetUsage.slice(0, 5).map((item, idx) => (
                            <div key={idx} className="bg-gray-50 rounded-lg p-4">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className={`text-sm font-bold ${parseFloat(item.percentage) > 90 ? 'text-red-600' :
                                        parseFloat(item.percentage) > 70 ? 'text-orange-600' :
                                            'text-green-600'
                                        }`}>
                                        {item.percentage}%
                                    </span>
                                ...
                                <div className="w-full bg-gray-200 rounded-full h-2.5">
                                    <div
                                        className={`h-2.5 rounded-full transition-all ${parseFloat(item.percentage) > 90 ? 'bg-gradient-to-r from-red-500 to-red-600' :
                                            parseFloat(item.percentage) > 70 ? 'bg-gradient-to-r from-orange-500 to-orange-600' :
            ...
            {/* Weekly Missions - 보기 쉽고 정확한 수치 */}
            <div className="bg-white rounded-xl p-6 shadow-sm border">
                <div className="flex items-center gap-2 mb-5">
                    <Repeat className="w-6 h-6 text-indigo-500" />
                    <h3 className="font-bold text-xl">주간 미션</h3>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    {weeklyMissions.map(mission => (
                        <div key={mission.id} className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border-2 border-indigo-200 hover:shadow-lg transition">
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-800 mb-1">{mission.title}</h4>
                                    <div className="text-xs text-gray-600">
                                        진행률: <span className="font-bold text-indigo-600">{Math.round((mission.progress / mission.target) * 100)}%</span>
                                    </div>
                                </div>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-xs text-gray-500">
                                        {mission.target - mission.progress}개 남음
                                    </span>
                                </div>
                            </div>
                        </div>
    ...
    const TaxPredictionView = () => {
        ...
        return (
            <div className="space-y-6">
                ...
                {/* AI Tax Benefit Recommendations */}
                <TaxBenefitRecommendations userType={userType} />

                {/* Loan Recommendations */}
                <LoanRecommendations userType={userType} />
            </div>
        );
    };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50">
            ...
            <header className="bg-white/80 backdrop-blur-xl border-b border-slate-200/50 sticky top-0 z-40 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <motion.div
                                className="w-12 h-12 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-200"
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 font-medium">AI 기반 스마트 세무 플랫폼</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <motion.button
                            ...
                            >
                                ...
                                {notificationCenter.filter(n => !n.read).length > 0 && (
                                    <motion.span
                                        className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-red-500 to-rose-500 text-white text-xs rounded-full flex items-center justify-center font-bold shadow-lg"
                                        initial={{ scale: 0 }}
                                        animate={{ scale: 1 }}
                            ...
                            <motion.label
                                className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-5 py-2.5 rounded-xl cursor-pointer hover:shadow-lg hover:shadow-blue-200 transition-all flex items-center gap-2 font-semibold"
                                whileHover={{ scale: 1.02, y: -2 }}
                                whileTap={{ scale: 0.98 }}
                            >
                                <Camera className="w-4 h-4" />
                                <span className="text-sm">OCR 스캔</span>
                                <input
                                    type="file"
                                    accept="image/*"
                                    className="hidden"
            ...
            {/* Premium Navigation */}
            <nav className="bg-white/80 backdrop-blur-lg border-b border-slate-200/50 sticky top-16 z-30 shadow-sm">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex gap-2 overflow-x-auto scrollbar-hide">
                        {[
                            { id: 'dashboard', label: '대시보드', icon: PieChart },
                            { id: 'receipts', label: '영수증/내역', icon: FileText },
                            ...
                            <motion.button
                                ...
                                className={`px-6 py-4 flex items-center gap-2 whitespace-nowrap transition-all relative ${currentTab === tab.id
...
export default EnhancedReceiptFinancePlatform;